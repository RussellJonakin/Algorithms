...
namespace SimpleAlgorithmsTest
{
    [TestClass]
    public class BinarySearchTest
    {
        ...
        public void UpperBoundTest_ListOfIntegers_0To100_100IsFound()
        {
            ...
            Assert.IsTrue(SimpleAlgorithms.BinarySearch.HasElement(x, target));
        }
        ...
        public void LowerBoundTestPlus1_ListOfIntegers_0To100_1IsFound()
        {
            ...
            Assert.IsTrue(SimpleAlgorithms.BinarySearch.HasElement(x, 1));
        }
        ...
        public void UpperBoundTestMinus1_ListOfIntegers_0To100_99IsFound()
        {
            ...
            Assert.IsTrue(SimpleAlgorithms.BinarySearch.HasElement(x, 99));
        }
        ...
        public void LargerNumberThanInListTest_ListOfIntegers_0To100_754IsNotFound()
        {
            ...
            Assert.IsFalse(SimpleAlgorithms.BinarySearch.HasElement(x, target));
        }
